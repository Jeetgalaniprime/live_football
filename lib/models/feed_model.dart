...
class FeedModel {
    ...
    factory FeedModel.fromJson(Map<String, dynamic> json) => FeedModel(
        countries: json["countries"] == null ? [] : List<FeedCountry>.from(json["countries"]!.map((x) => FeedCountry.fromJson(x))),
        numberOfLeaguesPerCountry: json["numberOfLeaguesPerCountry"],
        defaultFavorites: json["defaultFavorites"] == null ? null : DefaultFavorites.fromJson(json["defaultFavorites"]),
        defaultFavoritesV2: json["defaultFavoritesV2"] == null ? null : DefaultFavoritesV2.fromJson(json["defaultFavoritesV2"]),
        fixedCountries: json["fixedCountries"] == null ? [] : List<String>.from(json["fixedCountries"]!.map((x) => x)),
        tablelegendcolors: json["tablelegendcolors"] == null ? [] : List<Tablelegendcolor>.from(json["tablelegendcolors"]!.map((x) => Tablelegendcolor.fromJson(x))),
        specialItems: json["specialItems"] == null ? null : SpecialItems.fromJson(json["specialItems"]),
        ...
        paywallSkus: json["paywall_skus"] == null ? [] : List<PaywallSkus>.from(json["paywall_skus"]!.map((x) => PaywallSkus.fromJson(x))),
        ...
        interstitialPerViews: json["interstitial_per_views"] == null ? null : Interstitial.fromJson(json["interstitial_per_views"]),
        interstitialAfterMinutes: json["interstitial_after_minutes"] == null ? null : Interstitial.fromJson(json["interstitial_after_minutes"]),
        intersitialMinScreensPerView: json["intersitial_min_screens_per_view"],
        videoSearchQueryAppend: json["video_search_query_append"] == null ? null : VideoSearch.fromJson(json["video_search_query_append"]),
        videoSearchSortMethod: json["video_search_sort_method"] == null ? null : VideoSearch.fromJson(json["video_search_sort_method"]),
        videoSearchQueryAppendV2: json["video_search_query_append_v2"] == null ? null : VideoSearch.fromJson(json["video_search_query_append_v2"]),
        videoSearchSortMethodV2: json["video_search_sort_method_v2"] == null ? null : VideoSearch.fromJson(json["video_search_sort_method_v2"]),
        videoSearchQueryAppendV3: json["video_search_query_append_v3"] == null ? null : VideoSearch.fromJson(json["video_search_query_append_v3"]),
        videoSearchSortMethodV3: json["video_search_sort_method_v3"] == null ? null : VideoSearch.fromJson(json["video_search_sort_method_v3"]),
        supportedNewsSources: json["supportedNewsSources"] == null ? [] : List<dynamic>.from(json["supportedNewsSources"]!.map((x) => x)),
        supportedNewsSourcesV2: json["supportedNewsSources_v2"] == null ? [] : List<String>.from(json["supportedNewsSources_v2"]!.map((x) => x)),
        livestats: json["livestats"] == null ? null : Livestats.fromJson(json["livestats"]),
        showMatchChatV2: json["show_match_chat_v2"],
    );

    Map<String, dynamic> toJson() => {
        "countries": countries.isEmpty ? [] : List<dynamic>.from(countries.map((x) => x.toJson())),
        ...
        "fixedCountries": fixedCountries.isEmpty ? [] : List<dynamic>.from(fixedCountries.map((x) => x)),
        "tablelegendcolors": tablelegendcolors.isEmpty ? [] : List<dynamic>.from(tablelegendcolors.map((x) => x.toJson())),
        ...
        "paywall_skus": paywallSkus.isEmpty ? [] : List<dynamic>.from(paywallSkus.map((x) => x.toJson())),
        ...
        "supportedNewsSources": supportedNewsSources.isEmpty ? [] : List<dynamic>.from(supportedNewsSources.map((x) => x)),
        "supportedNewsSources_v2": supportedNewsSourcesV2.isEmpty ? [] : List<dynamic>.from(supportedNewsSourcesV2.map((x) => x)),
...
class FeedCountry {
    ...
    factory FeedCountry.fromRawJson(String str) => FeedCountry.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory FeedCountry.fromJson(Map<String, dynamic> json) => FeedCountry(
        leagues: json["leagues"] == null ? [] : List<CountryLeague>.from(json["leagues"]!.map((x) => CountryLeague.fromJson(x))),
        country: json["country"],
    );

    Map<String, dynamic> toJson() => {
        "leagues": leagues.isEmpty ? [] : List<dynamic>.from(leagues.map((x) => x.toJson())),
        "country": country,
    };
}
...
class CountryLeague {
    ...
    factory CountryLeague.fromRawJson(String str) => CountryLeague.fromJson(json.decode(str));
...
class DefaultFavorites {
    ...
    DefaultFavorites({
        this.defaultFavoritesDefault,
    });

    factory DefaultFavorites.fromRawJson(String str) => DefaultFavorites.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory DefaultFavorites.fromJson(Map<String, dynamic> json) => DefaultFavorites(
        defaultFavoritesDefault: json["default"] == null ? [] : List<DefaultFavoritesDefault>.from(json["default"]!.map((x) => DefaultFavoritesDefault.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "default": defaultFavoritesDefault == null ? [] : List<dynamic>.from(defaultFavoritesDefault!.map((x) => x.toJson())),
    };
}
...
class DefaultFavoritesDefault {
    ...
    factory DefaultFavoritesDefault.fromRawJson(String str) => DefaultFavoritesDefault.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory DefaultFavoritesDefault.fromJson(Map<String, dynamic> json) => DefaultFavoritesDefault(
        leagues: json["leagues"] == null ? [] : List<String>.from(json["leagues"]!.map((x) => x)),
        country: json["country"],
    );
...
class DefaultFavoritesV2 {
    ...
    DefaultFavoritesV2({
        this.defaultFavoritesV2Default = const [],
    });

    factory DefaultFavoritesV2.fromRawJson(String str) => DefaultFavoritesV2.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory DefaultFavoritesV2.fromJson(Map<String, dynamic> json) => DefaultFavoritesV2(
        defaultFavoritesV2Default: json["default"] == null ? [] : List<DefaultFavoritesV2Default>.from(json["default"]!.map((x) => DefaultFavoritesV2Default.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "default": defaultFavoritesV2Default.isEmpty ? [] : List<dynamic>.from(defaultFavoritesV2Default.map((x) => x.toJson())),
    };
}
...
class DefaultFavoritesV2Default {
    ...
    factory DefaultFavoritesV2Default.fromRawJson(String str) => DefaultFavoritesV2Default.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory DefaultFavoritesV2Default.fromJson(Map<String, dynamic> json) => DefaultFavoritesV2Default(
        leagues: json["leagues"] == null ? [] : List<DefaultLeague>.from(json["leagues"]!.map((x) => DefaultLeague.fromJson(x))),
        country: json["country"],
    );
...
class DefaultLeague {
    ...
    factory DefaultLeague.fromRawJson(String str) => DefaultLeague.fromJson(json.decode(str));
...
class Interstitial {
    ...
    factory Interstitial.fromRawJson(String str) => Interstitial.fromJson(json.decode(str));
...
class Livestats {
    ...
    factory Livestats.fromRawJson(String str) => Livestats.fromJson(json.decode(str));
    ...
    Map<String, dynamic> toJson() => {
        "countries": countries.isEmpty ? [] : List<dynamic>.from(countries.map((x) => x)),
        "leagues": leagues.isEmpty ? [] : List<dynamic>.from(leagues.map((x) => x)),
...
class PaywallSkus {
    ...
    factory PaywallSkus.fromRawJson(String str) => PaywallSkus.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory PaywallSkus.fromJson(Map<String, dynamic> json) => PaywallSkus(
        sku: json["sku"],
...
class SpecialItems {
    ...
    factory SpecialItems.fromRawJson(String str) => SpecialItems.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory SpecialItems.fromJson(Map<String, dynamic> json) => SpecialItems(
        entertainment: json["entertainment"] == null ? [] : List<Entertainment>.from(json["entertainment"].map((x) => Entertainment.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "entertainment": entertainment.isEmpty ? [] : List<dynamic>.from(entertainment.map((x) => x.toJson())),
    };
}
...
class Entertainment {
    ...
    factory Entertainment.fromRawJson(String str) => Entertainment.fromJson(json.decode(str));
...
class Tablelegendcolor {
    ...
    factory Tablelegendcolor.fromRawJson(String str) => Tablelegendcolor.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory Tablelegendcolor.fromJson(Map<String, dynamic> json) => Tablelegendcolor(
        name: json["name"],
        color: json["color"],
    );
...
class VideoSearch {
    ...
    factory VideoSearch.fromRawJson(String str) => VideoSearch.fromJson(json.decode(str));
